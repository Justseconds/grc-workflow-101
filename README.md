...
|---|---|---|
| **Download** | [⬇️ Download Sunset-Society-GRC-Template.xlsx](https://github.com/Justseconds/grc-workflow-101/raw/main/Sunset-Society-GRC-Template.xlsx) | [⬇️ Download GRC Empty template.xlsx](https://github.com/Justseconds/grc-workflow-101/raw/main/GRC%20Empty%20template.xlsx) |
| **View on GitHub** | [Open file page](https://github.com/Justseconds/grc-workflow-101/blob/main/Sunset-Society-GRC-Template.xlsx) | [Open file page](https://github.com/Justseconds/grc-workflow-101/blob/main/GRC%20Empty%20template.xlsx) |
...
> [!TIP]
> Open the files in **Microsoft Excel** so the risk scoring works as intended. The **Download** links save the file straight to your computer. The **Open file page** links take you to the file on GitHub, where you can use the **Download raw file** button.

---

## 🖼️ Preview: Sunset Society edition

![Colorful Start Here tab of the Sunset Society GRC workbook](sunset-grc-preview.png)

This is the **Start Here** tab of the Sunset Society version. It shows the seven-step workflow, the questions to ask before you begin, and the reminder to record an honest assessment state. The workbook is blank, so the risk record count starts at 0.
